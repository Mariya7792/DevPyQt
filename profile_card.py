...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_2.setCursor(QCursor(Qt.OpenHandCursor))
        ...
        self.lineEdit_3.setCursor(QCursor(Qt.OpenHandCursor))
        ...
        self.lineEdit_4.setCursor(QCursor(Qt.OpenHandCursor))
        self.lineEdit_4.setText(u"")
        self.lineEdit_4.setFrame(True)
        self.lineEdit_4.setCursorMoveStyle(Qt.CursorMoveStyle.LogicalMoveStyle)
        ...
        self.menubar.setGeometry(QRect(0, 0, 234, 22))
